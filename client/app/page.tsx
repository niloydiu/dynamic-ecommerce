        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg md:text-xl text-muted-foreground text-balance">
              Browse our curated collection of premium products. Fast shipping, secure checkout, and exceptional
              customer service.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Explore our handpicked selection of trending products loved by our customers
            </p>
          </div>
              ...
              >
                ...
                <div className="p-4 space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    High-quality product with exceptional design and functionality
                  </p>
                  <div className="flex items-center justify-between pt-2">
                    <span className="font-bold text-lg">${(99.99 + i * 10).toFixed(2)}</span>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">On orders over $50. Fast and reliable delivery</p>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">30-day return policy with no questions asked</p>
            </div>
          </div>
        </div>
      </section>
